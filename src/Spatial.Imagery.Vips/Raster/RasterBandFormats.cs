...
internal static class RasterBandFormats
{
    ...
    public static RasterPixelType ToCore(Enums.BandFormat format) => format switch
    {
    ...
    public static Enums.BandFormat ToVips(RasterPixelType pixelType) => pixelType switch
    {
