...
#
# The `map create`/`map set-style` verbs are implemented by a sibling
# worktree; until they land this script fails fast at that step.
...
SPATIAL_ADMIN_TOKEN="$TOKEN" ASPNETCORE_URLS="$HOST_URL" \
