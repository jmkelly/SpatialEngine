...
/// datasets a workspace wants ingested and the maps (maps) built from
...
/// <summary>One map the project wants to exist; <c>kind</c> selects the GeoServices projection.</summary>
