...
GET|POST /ogc/{name}/wms                 # OGC WMS 1.3.0 (Wms service): GetMap PNG/JPEG, GetFeatureInfo text/plain+text/html+text/xml+JSON+GML; EPSG:4326 is lat-first for 1.3.x but x-first for 1.1.1, and GetMap requires VERSION
